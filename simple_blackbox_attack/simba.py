...
def simba(
    model, image: torch.Tensor, label: int, basis: SearchVectors, step_size: float, device: str = "cpu"
) -> torch.Tensor:
    ...
    Args:
        ...
        device (str): the device the tensor and model will be stored, default 'cpu'
